...
%detection/training)
% default_params.detect_levels_per_octave = 10; --default parameter
default_params.detect_levels_per_octave = 3;
...
default_params.detect_min_scale = 0.5;
...
%during SVM learning
default_params.train_positives_constant = 5;
default_params.train_negatives_constant = 1;
